<head>
  ...
  <title>Online Training System</title>
...
<body id="page-top">
  ...
  <nav class="navbar navbar-expand-lg bg-secondary fixed-top text-uppercase" id="mainNav">
    <div class="container">
      <a style="color: white;">Welcome</a>&nbsp;&nbsp;&nbsp;<a class="navbar-brand js-scroll-trigger">${sessionScope.uName }</a>
      ...
      <div class="collapse navbar-collapse" id="navbarResponsive">
        <ul class="navbar-nav ml-auto">
          ...
          <li class="nav-item mx-0 mx-lg-1">
            <a class="nav-link py-3 px-0 px-lg-3 rounded js-scroll-trigger" href="ViewUsers">View Users</a>
          </li>
           <li class="nav-item mx-0 mx-lg-1">
